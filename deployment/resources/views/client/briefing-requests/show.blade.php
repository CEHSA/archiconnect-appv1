            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-green-300">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6">
                            ...
                            <ul class="mt-2 space-y-2">
                                @foreach ($briefingRequest->attachments as $attachment)
                                    <li class="text-gray-700 flex items-center">
                                        ...
                                        @endif
                                        <a href="{{ route('client.briefing-requests.download-attachment', $attachment) }}" class="text-indigo-600 hover:underline flex items-center">
                        ...
                        @else
                            <p class="mt-2 text-gray-600">No files were attached to this briefing request.</p>
                        @endif
                    </div>

                    <div class="mt-6">
                        <a href="{{ route('client.briefing-requests.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 focus:bg-gray-300 active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
