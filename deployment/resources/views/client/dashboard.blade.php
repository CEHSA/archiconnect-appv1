        ...
        <div class="space-y-4">
            ...
            @empty
                <p class="text-gray-500">You have no recent job requests.</p>
                 <a href="#" class="mt-4 inline-block px-6 py-2.5 bg-architimex-primary text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-architimex-primary-darker hover:shadow-lg focus:bg-architimex-primary-darker focus:shadow-lg focus:outline-none focus:ring-0 active:bg-architimex-primary-darker active:shadow-lg transition duration-150 ease-in-out">Create New Job Request</a>
            @endforelse
        </div>
    </div>
</x-layouts.client>
