                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-cyan-700">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Timer Actions</th>
                                    ...
                                    @foreach($tasks as $task)
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="mb-2 p-2 border border-blue-300 rounded bg-blue-50">
                                                        ...
                                                        <form method="POST" action="{{ route('freelancer.time-logs.stop', $runningLog) }}" enctype="multipart/form-data" class="mt-2">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <input type="file" name="proof_of_work" id="proof_of_work_{{ $runningLog->id }}" class="mt-1 block w-full text-sm text-gray-900 border-gray-300 rounded-md shadow-sm focus:border-cyan-500 focus:ring-cyan-500 file:mr-4 file:py-1 file:px-2 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200">
                                                            </div>
                                                        ...
                                                        @foreach($pendingLogs as $log)
                                                            <div class="text-xs p-1 my-1 border border-yellow-300 rounded bg-yellow-50">
                                                                ...
                                                                @if($log->proof_of_work_filename)
                                                                    <p>Proof: <a href="#" class="text-blue-600 hover:text-blue-700 hover:underline">{{ $log->proof_of_work_filename }}</a></p> {{-- TODO: Add download route --}}
                                                                @endif
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('freelancer.tasks.edit', $task) }}" class="text-blue-600 hover:text-blue-700 mr-2">Edit Task</a>
