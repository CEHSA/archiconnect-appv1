                    ...
                    @else
                        <ul class="space-y-4">
                            @foreach ($notifications as $notification)
                                <li class="p-4 bg-gray-100 dark:bg-gray-700 rounded-md shadow">
                                    <div class="flex justify-between items-center">
                                        <div>
                                            ...
                                            @if(isset($notification->data['url']))
                                                <a href="{{ $notification->data['url'] }}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">View Details</a>
                                            @endif
                    ...
                    @else
                        <ul class="space-y-4">
                            @foreach ($readNotifications as $notification)
                                <li class="p-4 bg-gray-200 dark:bg-gray-600 rounded-md shadow">
                                    <p class="font-semibold">{{ $notification->data['title'] ?? 'Notification' }}</p>
