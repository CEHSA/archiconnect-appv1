...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Architex Axis') }} Freelancer</title>
        <!-- Fonts -->
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex bg-architimex-lightbg">
            ...
            <aside class="w-64 bg-architimex-sidebar text-white flex-shrink-0">
                ...
                <nav class="mt-4 px-2">
                    {{-- Sidebar Navigation Slot or Hardcoded Links --}}                    <x-freelancer-nav-link :href="route('freelancer.dashboard')" :active="request()->routeIs('freelancer.dashboard')">
                        {{ __('Dashboard') }}
                    </x-freelancer-nav-link>
                    <x-freelancer-nav-link :href="route('freelancer.jobs.browse')" :active="request()->routeIs('freelancer.jobs.browse') || request()->routeIs('freelancer.jobs.show')">
                        {{ __('Browse All Jobs') }}
                    </x-freelancer-nav-link>
                    <x-freelancer-nav-link :href="route('freelancer.posted-jobs.index')" :active="request()->routeIs('freelancer.posted-jobs.index')">
                    ...
                    <x-freelancer-nav-link :href="route('freelancer.proposals.index')" :active="request()->routeIs('freelancer.proposals.*')">
                        {{ __('My Proposals') }}
                    </x-freelancer-nav-link>
                    <x-freelancer-nav-link :href="route('freelancer.messages.index')" :active="request()->routeIs('freelancer.messages.*')">
                        {{ __('Messages') }}
                    </x-freelancer-nav-link>
                    <x-freelancer-nav-link :href="route('notifications.index')" :active="request()->routeIs('notifications.*')">
