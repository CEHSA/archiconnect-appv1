...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="md:col-span-2">
        ...
        <div id="editor-container" class="mt-1 h-64 border border-gray-300 dark:border-gray-700 rounded-md"></div>
        <textarea id="description" name="description" class="hidden">{{ old('description', $job->description ?? '') }}</textarea>
    ...
    <div>
        ...
        <x-text-input id="hourly_rate" class="block mt-1 w-full" type="number" name="hourly_rate" :value="old('hourly_rate', $job->hourly_rate ?? '')" step="0.01" />
    ...
    <div>
        ...
        <x-text-input id="not_to_exceed_budget" class="block mt-1 w-full" type="number" name="not_to_exceed_budget" :value="old('not_to_exceed_budget', $job->not_to_exceed_budget ?? '')" step="0.01" />
...
<div class="flex items-center justify-end mt-6">
    <a href="{{ route('admin.jobs.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 mr-4">
        {{ __('Cancel') }}
    </a>
    <x-primary-button>
