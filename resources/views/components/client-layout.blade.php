        ...
        <div class="min-h-screen flex bg-architimex-lightbg">
            ...
            <aside class="w-64 bg-architimex-sidebar text-white flex-shrink-0">
                <div class="p-4 flex items-center space-x-2 border-b border-gray-700">
                    ...
                    <x-client-nav-link :href="route('client.profile.create')" :active="request()->routeIs('client.profile.*')">
                        {{ __('My Profile') }}
                    </x-client-nav-link>
                    <x-client-nav-link :href="route('client.jobs.index')" :active="request()->routeIs('client.jobs.*')">
                        {{ __('My Jobs') }}
                    </x-client-nav-link>
                    <x-client-nav-link :href="route('client.briefing-requests.index')" :active="request()->routeIs('client.briefing-requests.*')">
                        {{ __('My Briefing Requests') }}
                    </x-client-nav-link>
                    <x-client-nav-link :href="route('client.work-submissions.index')" :active="request()->routeIs('client.work-submissions.*')">
                        {{ __('Work Submissions for Review') }}
                    </x-client-nav-link>
                    <x-client-nav-link :href="route('client.messages.index')" :active="request()->routeIs('client.messages.*')">
                        {{ __('Messages') }}
                    </x-client-nav-link>
                    <x-client-nav-link :href="route('notifications.index')" :active="request()->routeIs('notifications.*')">
                        {{ __('Notifications') }}
                    </x-client-nav-link>
