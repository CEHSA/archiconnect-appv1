' platform.architex.co.za Secure WebDisk.vbs
'
...
' *************************************************************************
strURL = "\\platform.architex.co.za@SSL@2078\DavWWWRoot" ' This is the URL to the WebDAV share.
strDomainPort = "platform.architex.co.za@SSL@2078"
...
Sub CreateShorty ()
   ...
   strName = "platform.architex.co.za Secure WebDisk"
